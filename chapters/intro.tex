...
Basing on Gaisler's \leon~\cite{Leon} \fpga~implementation, this work presents a proof-of-concept of \cshia. The main goal of our implementation was to improve the original version of the architecture and add more flexible design choices. Besides presenting an in depth description of the integration between the architecture and a real processor.
